...
class Weather(commands.Cog):
    ...
    @commands.hybrid_command(name="weather", description="Checks the weather for a specific place",
    ...
    async def command(self, ctx, *, city: str, country: str = None):
        ...
        embed = discord.Embed(title=f"Weather for {response['name']}, {response['sys']['country']}",
