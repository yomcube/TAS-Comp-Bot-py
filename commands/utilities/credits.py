...
class Credits(commands.Cog):
    ...
    async def command(self, ctx):
        bot_credits = """**TASCompBot** is a multi TAS-Comp bot, that will be supporting both MKW TAS Comp and SM64 TAS Comp, and maybe even more in the future.\n
